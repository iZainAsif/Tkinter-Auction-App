...
from ChangeDet import UpdRec
from ItemStat import stat
...
class Seller(Person):
    ...
    def CreateAccount(self):
        ...
        brec.close()
        with open("Sellers.txt","a") as brec:
                brec.write(self._username + '\n')
    ...
    def home(lgn,uname):
        ...
        Label(hp,text="",bg="wheat4",height="2").pack()
        Button(hp,text="List Item",bg="misty rose",fg="VioletRed4",font=("Courier",15,"bold"),relief="raised",borderwidth=2,width="20",command= lambda:listitem(hp)).pack()
        Label(hp,text="",bg="wheat4",height="2").pack()
        Button(hp,text="Items Status",bg="misty rose",fg="VioletRed4",font=("Courier",15,"bold"),relief="raised",borderwidth=2,width="20",command= lambda: stat(hp)).pack()
        Label(hp,text="",bg="wheat4",height="2").pack()
        ...
        Label(hp,text="",bg="wheat4",height="2").pack()
        Button(hp,text="Delete Account",bg="misty rose",fg="VioletRed4",font=("Courier",15,"bold"),relief="raised",borderwidth=2,width="20",command= lambda:Seller.DeleteAccount(uname)).pack()
        Label(hp,text="",bg="wheat4",height="2").pack()
        Button(hp,text="Add Payment Method",bg="misty rose",fg="VioletRed4",font=("Courier",15,"bold"),relief="raised",borderwidth=2,width="20",command=lambda:Seller.pay(hp)).pack()
